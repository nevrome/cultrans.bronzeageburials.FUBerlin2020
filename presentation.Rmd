...
\begin{adjustwidth}{-3em}{-3em}
  \begin{figure}
    ...
    \caption{Plot matrix von Datierungen an Gräbern durch die Zeit. \newline 
    200 Jahre Zeitscheiben.
    }
  \end{figure}
\end{adjustwidth}
...
\begin{adjustwidth}{-3em}{-3em}
  \begin{figure}
    ...
    \caption{Korrelation der mittleren \textbf{burial type} und \textbf{burial construction} QED in 200 Jahre Zeitscheiben. Jeder Doppelpunkt repräsentiert ein Regionenpaar.}
  \end{figure}
\end{adjustwidth}
...
![...](../cultrans.bronzeageburials.article2020/analysis/figures/3D_plot_basic.png){ height=85% }

## 3D Tesselation: Idee

![...](../cultrans.bronzeageburials.article2020/analysis/figures/3D_plot_tesselation_burial_type.png){ height=85% }
...
## Gaussprozessregression: Idee

![...](../cultrans.bronzeageburials.article2020/analysis/figures/3D_plot_gpr_burial_type.png){ height=85% }

## Gaussprozessregression: Burial Type

\begin{adjustwidth}{-3em}{-3em}
  \begin{figure}
    \includegraphics{../cultrans.bronzeageburials.article2020/analysis/figures/gpr_matrix_burial_type.png}
    \caption{...}
  \end{figure}
\end{adjustwidth}

## Gaussprozessregression: Gruppen nach diachronem Verhalten

\begin{adjustwidth}{-3em}{-3em}
  \begin{figure}
    \includegraphics{../cultrans.bronzeageburials.article2020/analysis/figures/gpr_kmeans_iterative_bc+bt_3_sep.png}
    \caption{...}
  \end{figure}
\end{adjustwidth}
